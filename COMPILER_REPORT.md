...
Updated 2026-09-13T18:27:52.137534+00:00. Computational full MaleCNS experiments; no living tissue.
...
all available seeds: n=3, mean MaleCNS CE 88.0%, mean paired topology difference +30.73 pp. Seed SD: 5.76 pp (accuracy), 15.86 pp (difference). Paired gaps range from +12.50 to +41.41 pp; 3/3 are positive.

fresh seeds 1–4: n=2, mean MaleCNS CE 90.2%, mean paired topology difference +39.84 pp. Seed SD: 6.08 pp (accuracy), 2.21 pp (difference). Paired gaps range from +38.28 to +41.41 pp; 2/2 are positive.
