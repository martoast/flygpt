...
all available seeds: n=5, mean MaleCNS CE 90.3%, mean paired topology difference +35.16 pp. Seed SD: 5.40 pp (accuracy), 13.79 pp (difference). Paired gaps range from +12.50 to +49.22 pp; 5/5 are positive.

fresh seeds 1–4: n=4, mean MaleCNS CE 92.0%, mean paired topology difference +40.82 pp. Seed SD: 4.48 pp (accuracy), 6.29 pp (difference). Paired gaps range from +34.38 to +49.22 pp; 4/4 are positive.
...
- `results/compiler_v1/paired_ce/seed_4/real_ce`: 1024 updates; 7168 response symbols; 40.6 min; validation exact 96.9%.
- `results/compiler_v1/paired_ce/seed_4/rewired_ce`: 1024 updates; 7168 response symbols; 41.7 min; validation exact 59.4%.
